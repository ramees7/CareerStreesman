...
const TermsOfService = () => {
  ...
  return (
    ...
    >
      <Helmet>
        <meta charSet="utf-8" />
        <title>Terms of Service - Career Streesman</title>
        <link
          rel="canonical"
          href="https://careersteersman.com/termsofservice"
        />
        <meta
          name="description"
          content="Read the Terms of Service for Career Streesman to understand the rules and regulations governing the use of our services."
        />
        <meta
          property="og:title"
          content="Terms of Service - Career Streesman"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://careersteersman.com/termsofservice"
        />
      </Helmet>
      ...
      <div className="max-w-3xl mx-auto my-8 p-6 bg-white shadow-lg rounded-lg">
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            <span className="font-semibold">No Refunds:</span> Career Streesman
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            Trademarks: “Career Streesman” is a registered trademark of Career
            Streesman Pvt. Ltd. You may not use our trademark without prior
            written permission.
          </li>
          <li>
            Content: All content provided on our platform is owned by Career
            Streesman or its licensors and is protected by intellectual property
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            Career Streesman is not liable for any indirect, incidental, or
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            Career Streesman reserves the right to update or modify these Terms
            at any time. Any changes will be effective immediately upon posting
            on our website. Your continued use of our services after any
